# Паттерн предоставляет средства для создания обьекта посредника,
# который инкапсулирует взаимодействие между другими объектами

# Например у нас есть кнопки и действия. При нажатии кнопки мы должны только известить посреднека о нажатии
# А тот уведомит все обьекты, которые интерисуются нажатием
